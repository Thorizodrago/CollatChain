...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDEAM6F7UOL6DK3PGGZI4HC4RODPY5ZGBXGSIM7XCEG6PW5BV5BFHL22";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        init_vault: (json: string) => AssembledTransaction<null>;
        deposit_collateral: (json: string) => AssembledTransaction<null>;
        get_vault: (json: string) => AssembledTransaction<Option<Vault>>;
        borrow: (json: string) => AssembledTransaction<boolean>;
        repay: (json: string) => AssembledTransaction<boolean>;
        liquidate: (json: string) => AssembledTransaction<boolean>;
        set_price: (json: string) => AssembledTransaction<null>;
        withdraw_collateral: (json: string) => AssembledTransaction<boolean>;
    };
}
